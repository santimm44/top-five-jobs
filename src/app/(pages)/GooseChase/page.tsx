    ...
    return (
        <div>
            <div className='w-full h-screen relative'>
                <Image className='absolute' fill={true} src="/goosebanner.png" alt='hero image' />
                <div className='h-full w-[50rem] absolute bg-linear-to-r from-black to-transparent'>
                    ...
                    <div className='absolute top-1/3 left-0 w-3/5 ps-9 h-2/3 text-center rounded-sm text-white font-bold '>
                        <h1 className='text-8xl h-auto w-full '>GooseChase</h1>
                        <p className='text-xl leading-relaxed h-auto w-full mt-9 indent-16 text-left'>
                        &quot;We think the world needs more fun, so we built Goosechase for people to create engaging, delightful and out of the ordinary interactive experiences to be enjoyed anywhere.&quot;
                        </p>
                    </div>
            ...
            <div className='flex justify-center'>
                ...
                <PageContent Title='Staff Software Engineer(GooseChase)' />
            </div>
        </div>
    )
}
